...
import TokenBridgeContractArtifactJson from '../target/bridge-TokenBridge.json' with { type: 'json' };
...
export class TokenBridgeContract extends ContractBase {
  ...
  public static get storage(): ContractStorageLayout<'token' | 'portal'> {
      return {
        token: {
      slot: new Fr(1n),
    },
portal: {
      ...
      } as ContractStorageLayout<'token' | 'portal'>;
    }
  ...
  public declare methods: {
    ...
    /** exit_to_l1_private(recipient: struct, amount: integer, caller_on_l1: struct, authwit_nonce: field) */
    exit_to_l1_private: ((recipient: EthAddressLike, amount: (bigint | number), caller_on_l1: EthAddressLike, authwit_nonce: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
