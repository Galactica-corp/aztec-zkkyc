...
/**
 * Type-safe interface for contract PrivateStablecoin;
 */
export class PrivateStablecoinContract extends ContractBase {
  
  private constructor(
    address: AztecAddress,
    wallet: Wallet,
  ) {
    super(address, PrivateStablecoinContractArtifact, wallet);
  }
  ...
  public static at(
    ...
    return Contract.at(address, PrivateStablecoinContract.artifact, wallet) as PrivateStablecoinContract;
  }
   ...
   */
  public static deploy(wallet: Wallet, name: string, symbol: string, decimals: (bigint | number), admin: AztecAddressLike) {
    return new DeployMethod<PrivateStablecoinContract>(PublicKeys.default(), wallet, PrivateStablecoinContractArtifact, (instance, wallet) => PrivateStablecoinContract.at(instance.address, wallet), Array.from(arguments).slice(1));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified public keys hash to derive the address.
   */
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, name: string, symbol: string, decimals: (bigint | number), admin: AztecAddressLike) {
    return new DeployMethod<PrivateStablecoinContract>(publicKeys, wallet, PrivateStablecoinContractArtifact, (instance, wallet) => PrivateStablecoinContract.at(instance.address, wallet), Array.from(arguments).slice(2));
  }

  /**
   * Creates a tx to deploy a new instance of this contract using the specified constructor method.
   */
  public static deployWithOpts<M extends keyof PrivateStablecoinContract['methods']>(
    opts: { publicKeys?: PublicKeys; method?: M; wallet: Wallet },
    ...args: Parameters<PrivateStablecoinContract['methods'][M]>
  ) {
    return new DeployMethod<PrivateStablecoinContract>(
      opts.publicKeys ?? PublicKeys.default(),
      opts.wallet,
      PrivateStablecoinContractArtifact,
      (instance, wallet) => PrivateStablecoinContract.at(instance.address, wallet),
  ...
  public static get artifact(): ContractArtifact {
    return PrivateStablecoinContractArtifact;
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(PrivateStablecoinContractArtifactJson as NoirCompiledContract);
  }
  

  public static get storage(): ContractStorageLayout<'name' | 'symbol' | 'decimals' | 'private_balances' | 'total_supply' | 'public_balances' | 'minter' | 'admin'> {
      return {
        name: {
      slot: new Fr(1n),
    },
...
admin: {
      ...
      } as ContractStorageLayout<'name' | 'symbol' | 'decimals' | 'private_balances' | 'total_supply' | 'public_balances' | 'minter' | 'admin'>;
    }
  ...
  public declare methods: {
    ...
    /** constructor_with_minter(name: string, symbol: string, decimals: integer, admin: struct) */
    constructor_with_minter: ((name: string, symbol: string, decimals: (bigint | number), admin: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
    ...
    "path": "PrivateStablecoin::Transfer"
},
